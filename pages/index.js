 ...
 */}
      ...
      <div>
        <h1 className="font-title text-4xl mb-4">About</h1>
        <p>
          I am a Ecologist and Data Scientist currently working with Software
          Development. Among my main interests are creating solutions to
          problems related to data collection and display.
        </p>
      </div>
